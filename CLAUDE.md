...
- 압축 원칙 추가: 존댓말을 "남의 문장" 신호로 사용 (`lint:voice`). 공개 중 검출 23개 → 1개로 정리. 남은 `309.md`는 저자 본인 글이라 예외 → 577.md
  ...
  - 걷어내니 형태가 드러나 `type`이 바뀐 것: 46·269·23·247·271(→`bookmarks`), 56·340(→`snippet`), 329(→`note`)
